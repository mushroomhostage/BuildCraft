...
public class PipeLogicWood extends PipeLogic
{
    ...
    public void switchSource()
    {
        ...
        for (int var3 = var1 + 1; var3 <= var1 + 6; ++var3)
        {
            ...
            Block var6 = Block.blocksList[this.worldObj.getBlockId((int)var5.x, (int)var5.y, (int)var5.z)];
            TileEntity var7 = this.worldObj.getBlockTileEntity((int)var5.x, (int)var5.y, (int)var5.z);
    ...
    {
        return !(var1 instanceof TileGenericPipe) && (var1 instanceof IInventory || var1 instanceof ILiquidContainer) && Utils.checkPipesConnections(this.worldObj, this.xCoord, this.yCoord, this.zCoord, var1.xCoord, var1.yCoord, var1.zCoord);
    }
    ...
    public static boolean isExcludedFromExtraction(Block var0)
    {
        ...
        else
        {
            ...
            for (int var3 = 0; var3 < var2; ++var3)
            {
                ...
                if (var4.equals(var0.getBlockName()) || var4.equals(Integer.toString(var0.blockID)))
                {
                    return true;
                }
            }
