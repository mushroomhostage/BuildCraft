...
public enum Orientations
{
    ...
    {
        switch (Orientations.NamelessClass1926666868.$SwitchMap$net.minecraft.server$buildcraft$api$Orientations[this.ordinal()])
        {
            case 1:
                return YNeg;
    ...
    static class NamelessClass1926666868 {
