...
public class TankBucketHandler implements IBucketHandler
{
    ...
    {
        if (var1.getBlockId(var2, var3, var4) == BuildCraftFactory.tankBlock.blockID)
        {
            TileTank var5 = (TileTank)var1.getBlockTileEntity(var2, var3, var4);
            ...
            if (var6 >= 1000 && var7 > 0)
            {
                ...
                return new ItemStack(Item.itemsList[var7], 1);
            }
        }
