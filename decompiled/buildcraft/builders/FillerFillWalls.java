...
public class FillerFillWalls extends FillerPattern
{
    public boolean iteratePattern(TileEntity var1, IBox var2, ItemStack var3)
    {
        ...
        return !this.fill(var4, var5, var6, var7, var5, var9, var3, var1.worldObj) ? false : (!this.fill(var4, var5, var6, var4, var8, var9, var3, var1.worldObj) ? false : (!this.fill(var4, var5, var6, var7, var8, var6, var3, var1.worldObj) ? false : (!this.fill(var7, var5, var6, var7, var8, var9, var3, var1.worldObj) ? false : (!this.fill(var4, var5, var9, var7, var8, var9, var3, var1.worldObj) ? false : this.fill(var4, var8, var6, var7, var8, var9, var3, var1.worldObj)))));
    }
