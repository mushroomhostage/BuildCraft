...
public class BuildCraftCore
{
    ...
    public static String customBuildCraftTexture = "/net.minecraft.server/buildcraft/core/gui/block_textures.png";
    public static String customBuildCraftSprites = "/net.minecraft.server/buildcraft/core/gui/item_textures.png";
        ...
        if (!initialized)
        {
            ...
            else
            {
                try
                {
                    ...
                    else if (var5.startsWith("net.minecraft.server."))
                    {
                        var5 = var5.replace("net.minecraft.server.", "");
                    }
