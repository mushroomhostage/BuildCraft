...
public class BlockOilFlowing extends BlockFluids
{
    ...
    public void a(World var1, int var2, int var3, int var4, Random var5)
    {
        ...
        if (var6 > 0)
        {
            ...
            {
                int var12 = this.g(var1, var2, var3 + 1, var4);
                if (var12 >= 8)
                {
                    var9 = var12;
                }
    ...
    private int calculateFlowCost(World var1, int var2, int var3, int var4, int var5, int var6)
    {
        ...
        for (int var8 = 0; var8 < 4; ++var8)
        {
            if ((var8 != 0 || var6 != 1) && (var8 != 1 || var6 != 0) && (var8 != 2 || var6 != 3) && (var8 != 3 || var6 != 2))
            {
                ...
                if (!this.blockBlocksFlow(var1, var9, var3, var10) && (var1.getMaterial(var9, var3, var10) != this.material || var1.getData(var9, var3, var10) != 0))
                {
    ...
    private boolean[] getOptimalFlowDirections(World var1, int var2, int var3, int var4)
    {
        ...
        for (var5 = 0; var5 < 4; ++var5)
        {
            ...
            if (!this.blockBlocksFlow(var1, var6, var3, var7) && (var1.getMaterial(var6, var3, var7) != this.material || var1.getData(var6, var3, var7) != 0))
            {
