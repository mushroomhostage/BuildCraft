...
public class TileMarker extends TileBuildCraft implements IAreaProvider
{
    ...
    public void destroy()
    {
        ...
        if (this.origin.isSet())
        {
            ...
            TileMarker.Origin var3 = this.origin;
            if (var1 != null && var1.lasers != null)
            {
                EntityBlock[] var5 = var1.lasers;
                var2 = var5.length;

                for (var4 = 0; var4 < var2; ++var4)
                {
                    EntityBlock var6 = var5[var4];
                    if (var6 != null)
                    {
                        var6.die();
                    }
            ...
            TileMarker.TileWrapper[] var9 = var3.vect;
            var2 = var9.length;

            TileMarker.TileWrapper var7;
            TileMarker var11;
            for (var4 = 0; var4 < var2; ++var4)
            {
                var7 = var9[var4];
                var11 = var7.getMarker(this.world);
                if (var11 != null)
                {
                    var11.lasers = null;
                    if (var11 != this)
                    {
                        var11.origin = new TileMarker.Origin();
                    }
                }
            }
    ...
    public void removeFromWorld()
    {
        if (this.origin.isSet())
        {
            ...
            TileMarker.TileWrapper[] var2 = (TileMarker.TileWrapper[])((TileMarker.TileWrapper[])var1.vect.clone());
