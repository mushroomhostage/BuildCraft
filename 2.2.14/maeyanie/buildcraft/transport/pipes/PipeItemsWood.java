...
import maeyanie.PipeExtractEvent;
    ...
    public void doWork()
    {
        if (this.powerProvider.energyStored > 0)
        {
            ...
            if (var2 <= 5)
            {
                ...
                if (var5 != null && (var5 instanceof IInventory || var5 instanceof ILiquidContainer) && !PipeLogicWood.isExcludedFromExtraction(Block.byId[var4]) && var5 instanceof IInventory)
                {
                    IInventory var6 = (IInventory)var5;
                    ItemStack var7 = this.checkExtract(var6, false, var3.orientation.reverse());
                    org.bukkit.block.Block var8 = this.worldObj.getWorld().getBlockAt((int)var3.x, (int)var3.y, (int)var3.z);
                    org.bukkit.block.Block var9 = this.worldObj.getWorld().getBlockAt(this.xCoord, this.yCoord, this.zCoord);
                    PipeExtractEvent var10 = new PipeExtractEvent(var8, var9, var7);
                    ...
                    Position var11 = new Position(var3.x + 0.5D, var3.y + (double)Utils.getPipeFloorOf(var7), var3.z + 0.5D, var3.orientation.reverse());
                    var11.moveForwards(0.5D);
                    EntityPassiveItem var12 = new EntityPassiveItem(var1, var11.x, var11.y, var11.z, var7);
                    ((PipeTransportItems)this.transport).entityEntering(var12, var11.orientation);
                }
            }
        }
    ...
    public ItemStack checkExtract(IInventory var1, boolean var2, Orientations var3)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    var7 = Utils.getInventory(var1);
                    var11 = this.checkExtractGeneric(var7, var2, var3, 0, var7.getSize() - 1);
                    if (var11 != null)
                    {
                        return var11;
                    }
