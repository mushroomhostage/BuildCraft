   ...
   public void doWork() {
      if(this.powerProvider.energyStored > 0) {
         ...
         if(var2 <= 5) {
            ...
            if(var5 != null && var5 instanceof ILiquidContainer && !PipeLogicWood.isExcludedFromExtraction(Block.byId[var4]) && var5 instanceof ILiquidContainer && this.liquidToExtract <= 1000) {
