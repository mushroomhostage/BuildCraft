...
public class PacketPayload {
   ...
   public void append(PacketPayload var1) {
      if(var1 != null) {
         if(var1.intPayload.length > 0) {
            this.intPayload = Utils.concat(this.intPayload, var1.intPayload);
         }

         if(var1.floatPayload.length > 0) {
            this.floatPayload = Utils.concat(this.floatPayload, var1.floatPayload);
         }

         if(var1.stringPayload.length > 0) {
            this.stringPayload = (String[])((String[])Utils.concat((Object[])this.stringPayload, (Object[])var1.stringPayload));
         }
      }
   ...
   public void append(int[] var1) {
      if(var1 != null && var1.length >= 0) {
         this.intPayload = Utils.concat(this.intPayload, var1);
      }
