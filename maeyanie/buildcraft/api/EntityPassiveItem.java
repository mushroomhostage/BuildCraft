...
public class EntityPassiveItem {
   ...
   public EntityItem toEntityItem(Orientations var1) {
      if(this.worldObj == null) {
         if(this.container != null && this.container.world != null) {
            MinecraftServer.log.fine("[BuildCraft] EntityPassiveItem.toEntityItem: World was null! Using container\'s world.");
            this.worldObj = this.container.world;
         } else {
            MinecraftServer.log.fine("[BuildCraft] EntityPassiveItem.toEntityItem: World was null! Using default world.");
