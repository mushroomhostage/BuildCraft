...
public class FillerFlattener extends FillerPattern {
   ...
   public boolean iteratePattern(TileEntity var1, IBox var2, ItemStack var3) {
      ...
      for(int var13 = 0; var13 < var11.length; ++var13) {
         for(var12 = 0; var12 < var11[0].length; ++var12) {
            var11[var13][var12] = false;
         }
      }
      ...
      if(var12 != Integer.MAX_VALUE && var3 != null) {
         var3.getItem().interactWith(var3, BuildCraftCore.getBuildCraftPlayer(var1.world), var1.world, var12, var14 + 1, var15, 0);
      }
