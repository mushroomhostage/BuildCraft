...
public class EngineIron extends Engine {
   ...
   public void burn() {
      EngineFuel var1 = (EngineFuel)TileEngine.possibleFuels.get(Integer.valueOf(this.liquidId));
      if(var1 != null) {
   ...
   public Engine.EnergyStage getEnergyStage() {
      return this.heat <= MAX_HEAT / 4?Engine.EnergyStage.Blue:(this.heat <= MAX_HEAT / 2?Engine.EnergyStage.Green:((float)this.heat <= (float)MAX_HEAT * 3.0F / 4.0F?Engine.EnergyStage.Yellow:(this.heat <= MAX_HEAT?Engine.EnergyStage.Red:Engine.EnergyStage.Explosion)));
   }
   ...
   public int fill(Orientations var1, int var2, int var3, boolean var4) {
      if(var3 == Block.STATIONARY_WATER.id) {
         ...
         if(this.liquidQty > 0 && this.liquidId != var3) {
            return 0;
         } else if(!TileEngine.possibleFuels.containsKey(Integer.valueOf(var3))) {
            return 0;
         } else {
            int var6;
