...
public class OilPopulate {
   ...
   public static void doPopulate(World var0, int var1, int var2) {
      ...
      int var7;
      int var8;
      if(var3 == BiomeBase.DESERT && (double)var0.random.nextFloat() > 0.97D) {
         int var4 = var0.random.nextInt(10) + 2;
         int var5 = var0.random.nextInt(10) + 2;
      ...
      boolean var15 = var0.random.nextDouble() <= 0.001D;
      boolean var16 = var0.random.nextDouble() <= 5.0E-5D;
      if(var15 || var16) {
         var6 = var1;
         var7 = 20 + var0.random.nextInt(10);
         var8 = var2;
         int var9 = 0;
         if(var16) {
            var9 = 8 + var0.random.nextInt(9);
         } else if(var15) {
            var9 = 3 + var0.random.nextInt(4);
         }
         ...
         for(var12 = 128; var12 >= var7; --var12) {
            if(!var17 && var0.getTypeId(var6, var12, var8) != 0 && var0.getTypeId(var6, var12, var8) != Block.LEAVES.id && var0.getTypeId(var6, var12, var8) != Block.LOG.id && var0.getTypeId(var6, var12, var8) != Block.GRASS.id) {
               var17 = true;
               if(var16) {
                  generateSurfaceDeposit(var0, var6, var12, var8, 20 + var0.random.nextInt(20));
               } else if(var15) {
                  generateSurfaceDeposit(var0, var6, var12, var8, 5 + var0.random.nextInt(5));
               }
   ...
   public static void setOilWithProba(World var0, float var1, int var2, int var3, int var4, boolean var5) {
      if(var0.random.nextFloat() <= var1 && var0.getTypeId(var2, var3 - 2, var4) != 0 || var5) {
         boolean var6 = false;
