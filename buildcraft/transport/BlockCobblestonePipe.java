...
public class BlockCobblestonePipe extends BlockPipe {
   ...
   public BlockCobblestonePipe(int var1) {
   ...
   public boolean isPipeConnected(IBlockAccess var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      ...
      return BuildCraftTransport.alwaysConnectPipes?super.isPipeConnected(var1, var2, var3, var4, var5, var6, var7):!(var8 instanceof TileStonePipe) && super.isPipeConnected(var1, var2, var3, var4, var5, var6, var7);
   }
}
